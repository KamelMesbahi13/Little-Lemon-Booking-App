      ...
      <div className="language-select">
        <div className="flex items-center justify-end language-select-root">
          <div className="relative">
            ...
            {isOpen && (
              <ul className="absolute z-[99] px-8 mt-2 mr-12 rtl:md:right-[-7rem] bg-white border-2 border-[#eee] rounded-md shadow-2xl md:mr-0 -right-12">
                <li>
                  <h6 className="block px-2 py-1 text-lg font-bold lg:px-4 lg:py-2">
                    {t("Language")}
                  </h6>
                </li>
                <div>
